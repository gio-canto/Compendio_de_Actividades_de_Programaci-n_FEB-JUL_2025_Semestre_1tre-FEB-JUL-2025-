...
int spa;            // Suma total de personas a bordo en los autobuses
int tipoVehiculo;   // Tipo de vehículo (1=Auto, 2=Autobús, 3=Camión, 4=Moto)
int npv;            // Número de personas a bordo del vehículo
...
int main() {
    ...
    cout << "\n==============================================" << endl;
    cout << "      [Sistema] RNO/ITS - CAPUFE - SCT" << endl;
    cout << "==============================================" << endl;

    cout << "\n¿Hay un vehículo que pasará? (SI/NO): ";
    cin >> respuesta;
    ...
    while (respuesta == "SI" || respuesta == "si") {
        ...
        cout << "Número de personas a bordo: ";
        cin >> npv;
        ...
        cout << "\n¿Desea registrar otro vehículo? (SI/NO): ";
        cin >> respuesta;
    ...
    cout << "\n==============================================" << endl;
    cout << "         [Fin del reporte - Gracias]" << endl;
    cout << "==============================================\n" << endl;
