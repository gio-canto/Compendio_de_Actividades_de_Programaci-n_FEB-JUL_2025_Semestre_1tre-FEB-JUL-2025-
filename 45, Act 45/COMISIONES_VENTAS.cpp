...
int main() {
    ...
    cout << fixed << setprecision(2); // Mostrar números decimales con 2 cifras
    cout << "=========================================" << endl;
    ...
    cout << "Total de ventas realizadas: " << ventas_total << endl;
    cout << "Comisión 3% (ventas < $1000): $" << comision3 << endl;
    cout << "Comisión 5% (ventas >= $1000): $" << comision5 << endl;
    cout << "Comisión total: $" << comision3 + comision5 << endl;
    cout << "Promedio de ventas menores a $1000: $" << promedio_menores << endl;
    cout << "=========================================" << endl;
